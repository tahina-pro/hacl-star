...
static uint32_t Hacl_Impl_Chacha20_Vec128_vecsizebytes4 = (uint32_t )64;
...
{
  KRML_CHECK_SIZE((uint8_t )0, Hacl_Impl_Chacha20_Vec128_vecsizebytes4);
  uint8_t block[Hacl_Impl_Chacha20_Vec128_vecsizebytes4];
  memset(block, 0, Hacl_Impl_Chacha20_Vec128_vecsizebytes4 * sizeof block[0]);
...
void *Chacha20_Vec128_op_String_Access(FStar_HyperStack_mem h, uint8_t *b)
{
