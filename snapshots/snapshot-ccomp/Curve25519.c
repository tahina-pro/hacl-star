...
inline static void Hacl_Bignum_fscalar(uint64_t *output, uint64_t *b, uint64_t s)
{
  ...
  for (uintmax_t _i = 0; _i < (uint32_t )5; ++_i)
    tmp[_i] = ret0;
  {
    uint64_t uu____381 = b[0];
    FStar_UInt128_t uu____380;
    FStar_UInt128_mul_wide(uu____381, s, &uu____380);
    tmp[0] = uu____380;
  }
  {
    uint64_t uu____381 = b[1];
    FStar_UInt128_t uu____380;
    FStar_UInt128_mul_wide(uu____381, s, &uu____380);
    tmp[1] = uu____380;
  }
  {
    uint64_t uu____381 = b[2];
    FStar_UInt128_t uu____380;
    FStar_UInt128_mul_wide(uu____381, s, &uu____380);
    tmp[2] = uu____380;
  }
  {
    uint64_t uu____381 = b[3];
    FStar_UInt128_t uu____380;
    FStar_UInt128_mul_wide(uu____381, s, &uu____380);
    tmp[3] = uu____380;
  }
  {
    uint64_t uu____381 = b[4];
    FStar_UInt128_t uu____380;
    FStar_UInt128_mul_wide(uu____381, s, &uu____380);
    tmp[4] = uu____380;
  }
