...
static void Hacl_Hash_SHA2_256_update(uint32_t *state, uint8_t *data)
{
  ...
  {
    uint32_t uu____763 = hash_w[0];
    uint32_t uu____766 = hash_0[0];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[0] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[1];
    uint32_t uu____766 = hash_0[1];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[1] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[2];
    uint32_t uu____766 = hash_0[2];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[2] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[3];
    uint32_t uu____766 = hash_0[3];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[3] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[4];
    uint32_t uu____766 = hash_0[4];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[4] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[5];
    uint32_t uu____766 = hash_0[5];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[5] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[6];
    uint32_t uu____766 = hash_0[6];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[6] = uu____762;
  }
  {
    uint32_t uu____763 = hash_w[7];
    uint32_t uu____766 = hash_0[7];
    uint32_t uu____762 = uu____763 + uu____766;
    hash_w[7] = uu____762;
  }
...
static void Hacl_Hash_SHA2_256_update_multi(uint32_t *state, uint8_t *data, uint32_t n1)
{
  ...
  else
  {
    ...
    Hacl_Hash_SHA2_256_update_multi(state, data1, n1 - (uint32_t )1);
    return;
  }
}
...
static void Hacl_Hash_SHA2_256_update_last(uint32_t *state, uint8_t *data, uint32_t len)
{
  ...
  K___uint32_t_uint8_t_ uu____1429;
  if (len < (uint32_t )56)
    uu____1429 = ((K___uint32_t_uint8_t_ ){ .fst = (uint32_t )1, .snd = blocks + (uint32_t )64 });
  else
    uu____1429 = ((K___uint32_t_uint8_t_ ){ .fst = (uint32_t )2, .snd = blocks });
  K___uint32_t_uint8_t_ scrut = uu____1429;
