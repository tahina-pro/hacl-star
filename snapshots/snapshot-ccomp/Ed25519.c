...
Hacl_Bignum_Fproduct_copy_from_wide_(uint64_t *output, FStar_UInt128_t *input)
{
  ...
  {
    FStar_UInt128_t uu____381 = input[3];
    uint64_t uu____380 = FStar_Int_Cast_uint128_to_uint64(&uu____381);
    output[3] = uu____380;
  }
  {
    FStar_UInt128_t uu____381 = input[4];
    uint64_t uu____380 = FStar_Int_Cast_uint128_to_uint64(&uu____381);
    output[4] = uu____380;
  }
}
...
)
{
  ...
  {
    FStar_UInt128_t uu____763 = output[3];
    uint64_t uu____766 = input[3];
    FStar_UInt128_t uu____762;
    FStar_UInt128_t ret;
    FStar_UInt128_mul_wide(uu____766, s, &ret);
    FStar_UInt128_t s1 = ret;
  ...
  {
    FStar_UInt128_t uu____763 = output[4];
    uint64_t uu____766 = input[4];
    FStar_UInt128_t uu____762;
    FStar_UInt128_t ret;
    FStar_UInt128_mul_wide(uu____766, s, &ret);
    FStar_UInt128_t s1 = ret;
...
{
  {
    ...
    FStar_UInt128_t c;
    FStar_UInt128_shift_right(&tctr, (uint32_t )51, &c);
...
inline static void Hacl_Bignum_Fmul_fmul_(uint64_t *output, uint64_t *input, uint64_t *input2)
{
  ...
  FStar_Int_Cast_uint64_to_uint128((uint64_t )0, &ret0);
  ...
  FStar_UInt128_t mask;
  FStar_UInt128_t ret1;
  FStar_Int_Cast_uint64_to_uint128((uint64_t )1, &ret1);
  FStar_UInt128_t s1 = ret1;
  FStar_UInt128_t ret2;
  FStar_UInt128_t ret3;
  FStar_Int_Cast_uint64_to_uint128((uint64_t )1, &ret3);
  FStar_UInt128_t s0 = ret3;
  FStar_UInt128_shift_left(&s0, (uint32_t )51, &ret2);
  FStar_UInt128_t s00 = ret2;
  FStar_UInt128_sub(&s00, &s1, &mask);
  FStar_UInt128_t b4_;
  FStar_UInt128_logand(&b4, &mask, &b4_);
  FStar_UInt128_t b0_;
  FStar_UInt128_t ret4;
  FStar_UInt128_t ret;
  FStar_UInt128_shift_right(&b4, (uint32_t )51, &ret);
  FStar_UInt128_t s01 = ret;
  FStar_UInt128_mul_wide((uint64_t )19, FStar_Int_Cast_uint128_to_uint64(&s01), &ret4);
  FStar_UInt128_t s10 = ret4;
...
inline static void Hacl_Bignum_Fsquare_fsquare__(FStar_UInt128_t *tmp, uint64_t *output)
{
  ...
  FStar_UInt128_t s0;
  FStar_UInt128_t ret0;
  FStar_UInt128_mul_wide(d2, r3, &ret0);
  FStar_UInt128_t s1 = ret0;
  FStar_UInt128_t ret1;
  FStar_UInt128_t ret2;
  FStar_UInt128_mul_wide(d4, r1, &ret2);
  FStar_UInt128_t s10 = ret2;
  FStar_UInt128_t ret3;
  FStar_UInt128_mul_wide(r0, r0, &ret3);
  FStar_UInt128_t s00 = ret3;
  FStar_UInt128_add(&s00, &s10, &ret1);
  FStar_UInt128_t s01 = ret1;
  FStar_UInt128_add(&s01, &s1, &s0);
  FStar_UInt128_t s11;
  FStar_UInt128_t ret4;
  FStar_UInt128_mul_wide(r3 * (uint64_t )19, r3, &ret4);
  FStar_UInt128_t s12 = ret4;
  FStar_UInt128_t ret5;
  FStar_UInt128_t ret6;
  FStar_UInt128_mul_wide(d4, r2, &ret6);
  FStar_UInt128_t s13 = ret6;
  FStar_UInt128_t ret7;
  FStar_UInt128_mul_wide(d0, r1, &ret7);
  FStar_UInt128_t s02 = ret7;
  FStar_UInt128_add(&s02, &s13, &ret5);
  FStar_UInt128_t s03 = ret5;
  FStar_UInt128_add(&s03, &s12, &s11);
  FStar_UInt128_t s2;
  FStar_UInt128_t ret8;
  FStar_UInt128_mul_wide(d4, r3, &ret8);
  FStar_UInt128_t s14 = ret8;
  FStar_UInt128_t ret9;
  FStar_UInt128_t ret10;
  FStar_UInt128_mul_wide(r1, r1, &ret10);
  FStar_UInt128_t s15 = ret10;
  FStar_UInt128_t ret11;
  FStar_UInt128_mul_wide(d0, r2, &ret11);
  FStar_UInt128_t s04 = ret11;
  FStar_UInt128_add(&s04, &s15, &ret9);
  FStar_UInt128_t s05 = ret9;
  FStar_UInt128_add(&s05, &s14, &s2);
  FStar_UInt128_t s3;
  FStar_UInt128_t ret12;
  FStar_UInt128_mul_wide(r4, d419, &ret12);
  FStar_UInt128_t s16 = ret12;
  FStar_UInt128_t ret13;
  FStar_UInt128_t ret14;
  FStar_UInt128_mul_wide(d1, r2, &ret14);
  FStar_UInt128_t s17 = ret14;
  FStar_UInt128_t ret15;
  FStar_UInt128_mul_wide(d0, r3, &ret15);
  FStar_UInt128_t s06 = ret15;
  FStar_UInt128_add(&s06, &s17, &ret13);
  FStar_UInt128_t s07 = ret13;
  FStar_UInt128_add(&s07, &s16, &s3);
  FStar_UInt128_t s4;
  FStar_UInt128_t ret16;
  FStar_UInt128_mul_wide(r2, r2, &ret16);
  FStar_UInt128_t s18 = ret16;
  FStar_UInt128_t ret17;
  FStar_UInt128_t ret18;
  FStar_UInt128_mul_wide(d1, r3, &ret18);
  FStar_UInt128_t s19 = ret18;
  FStar_UInt128_t ret;
  FStar_UInt128_mul_wide(d0, r4, &ret);
  FStar_UInt128_t s08 = ret;
  FStar_UInt128_add(&s08, &s19, &ret17);
  FStar_UInt128_t s09 = ret17;
  FStar_UInt128_add(&s09, &s18, &s4);
...
inline static void Hacl_Bignum_Fsquare_fsquare_(FStar_UInt128_t *tmp, uint64_t *output)
{
  ...
  FStar_UInt128_t mask;
  FStar_UInt128_t ret0;
  FStar_Int_Cast_uint64_to_uint128((uint64_t )1, &ret0);
  FStar_UInt128_t s1 = ret0;
  FStar_UInt128_t ret1;
  FStar_UInt128_t ret2;
  FStar_Int_Cast_uint64_to_uint128((uint64_t )1, &ret2);
  FStar_UInt128_t s0 = ret2;
  FStar_UInt128_shift_left(&s0, (uint32_t )51, &ret1);
  FStar_UInt128_t s00 = ret1;
  FStar_UInt128_sub(&s00, &s1, &mask);
  FStar_UInt128_t b4_;
  FStar_UInt128_logand(&b4, &mask, &b4_);
  FStar_UInt128_t b0_;
  ...
  FStar_UInt128_shift_right(&b4, (uint32_t )51, &ret);
  FStar_UInt128_t s01 = ret;
  FStar_UInt128_mul_wide((uint64_t )19, FStar_Int_Cast_uint128_to_uint64(&s01), &ret3);
  FStar_UInt128_t s10 = ret3;
  FStar_UInt128_add(&b0, &s10, &b0_);
  tmp[4] = b4_;
  tmp[0] = b0_;
...
{
  {
    uint64_t uu____763 = a[0];
    uint64_t uu____766 = b[0];
    uint64_t uu____762 = uu____763 + uu____766;
    a[0] = uu____762;
  }
  {
    uint64_t uu____763 = a[1];
    uint64_t uu____766 = b[1];
    uint64_t uu____762 = uu____763 + uu____766;
    a[1] = uu____762;
  }
  {
    uint64_t uu____763 = a[2];
    uint64_t uu____766 = b[2];
    uint64_t uu____762 = uu____763 + uu____766;
    a[2] = uu____762;
  }
  {
    uint64_t uu____763 = a[3];
    uint64_t uu____766 = b[3];
    uint64_t uu____762 = uu____763 + uu____766;
    a[3] = uu____762;
  }
  {
    uint64_t uu____763 = a[4];
    uint64_t uu____766 = b[4];
    uint64_t uu____762 = uu____763 + uu____766;
    a[4] = uu____762;
  }
}
...
inline static void Hacl_Bignum_fdifference(uint64_t *a, uint64_t *b)
{
  ...
  {
    uint64_t uu____763 = a[0];
    uint64_t uu____766 = tmp[0];
    uint64_t uu____762 = uu____766 - uu____763;
    a[0] = uu____762;
  }
  {
    uint64_t uu____763 = a[1];
    uint64_t uu____766 = tmp[1];
    uint64_t uu____762 = uu____766 - uu____763;
    a[1] = uu____762;
  }
  {
    uint64_t uu____763 = a[2];
    uint64_t uu____766 = tmp[2];
    uint64_t uu____762 = uu____766 - uu____763;
    a[2] = uu____762;
  }
  {
    uint64_t uu____763 = a[3];
    uint64_t uu____766 = tmp[3];
    uint64_t uu____762 = uu____766 - uu____763;
    a[3] = uu____762;
  }
  {
    uint64_t uu____763 = a[4];
    uint64_t uu____766 = tmp[4];
    uint64_t uu____762 = uu____766 - uu____763;
    a[4] = uu____762;
  }
}
...
static void Hacl_Hash_SHA2_512_update(uint64_t *state, uint8_t *data)
{
  ...
  {
    uint64_t uu____763 = hash_w[0];
    uint64_t uu____766 = hash_0[0];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[0] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[1];
    uint64_t uu____766 = hash_0[1];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[1] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[2];
    uint64_t uu____766 = hash_0[2];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[2] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[3];
    uint64_t uu____766 = hash_0[3];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[3] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[4];
    uint64_t uu____766 = hash_0[4];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[4] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[5];
    uint64_t uu____766 = hash_0[5];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[5] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[6];
    uint64_t uu____766 = hash_0[6];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[6] = uu____762;
  }
  {
    uint64_t uu____763 = hash_w[7];
    uint64_t uu____766 = hash_0[7];
    uint64_t uu____762 = uu____763 + uu____766;
    hash_w[7] = uu____762;
  }
...
static void Hacl_Hash_SHA2_512_update_last(uint64_t *state, uint8_t *data, uint64_t len1)
{
  ...
  K___uint32_t_uint8_t_ uu____1606;
  if (len1 < (uint64_t )112)
    uu____1606 = ((K___uint32_t_uint8_t_ ){ .fst = (uint32_t )1, .snd = blocks + (uint32_t )128 });
  else
    uu____1606 = ((K___uint32_t_uint8_t_ ){ .fst = (uint32_t )2, .snd = blocks });
  K___uint32_t_uint8_t_ scrut = uu____1606;
  ...
  FStar_UInt128_t ret0;
  FStar_UInt128_t ret1;
  FStar_Int_Cast_uint64_to_uint128(len1, &ret1);
  FStar_UInt128_t s1 = ret1;
  FStar_UInt128_t ret;
  FStar_UInt128_mul_wide(n1, (uint64_t )(uint32_t )128, &ret);
  FStar_UInt128_t s0 = ret;
  FStar_UInt128_add(&s0, &s1, &ret0);
  FStar_UInt128_t s00 = ret0;
  FStar_UInt128_shift_left(&s00, (uint32_t )3, &encodedlen);
  buf1[0] = (uint8_t )0x80;
...
static void Hacl_Impl_BignumQ_Mul_low_mul_5(uint64_t *z, uint64_t *x, uint64_t *y)
{
  ...
  uint64_t y3 = y[3];
  uint64_t y4 = y[4];
  FStar_UInt128_t xy00;
  FStar_UInt128_mul_wide(x0, y0, &xy00);
  FStar_UInt128_t xy01;
  FStar_UInt128_mul_wide(x0, y1, &xy01);
  FStar_UInt128_t xy02;
  FStar_UInt128_mul_wide(x0, y2, &xy02);
  FStar_UInt128_t xy03;
  FStar_UInt128_mul_wide(x0, y3, &xy03);
  FStar_UInt128_t xy04;
  FStar_UInt128_mul_wide(x0, y4, &xy04);
  FStar_UInt128_t xy10;
  FStar_UInt128_mul_wide(x1, y0, &xy10);
  FStar_UInt128_t xy11;
  FStar_UInt128_mul_wide(x1, y1, &xy11);
  FStar_UInt128_t xy12;
  FStar_UInt128_mul_wide(x1, y2, &xy12);
  FStar_UInt128_t xy13;
  FStar_UInt128_mul_wide(x1, y3, &xy13);
  FStar_UInt128_t xy20;
  FStar_UInt128_mul_wide(x2, y0, &xy20);
  FStar_UInt128_t xy21;
  FStar_UInt128_mul_wide(x2, y1, &xy21);
  FStar_UInt128_t xy22;
  FStar_UInt128_mul_wide(x2, y2, &xy22);
  FStar_UInt128_t xy30;
  FStar_UInt128_mul_wide(x3, y0, &xy30);
  FStar_UInt128_t xy31;
  FStar_UInt128_mul_wide(x3, y1, &xy31);
  FStar_UInt128_t xy40;
  FStar_UInt128_mul_wide(x4, y0, &xy40);
  FStar_UInt128_t x5 = xy00;
  FStar_UInt128_t carry1;
  FStar_UInt128_shift_right(&x5, (uint32_t )56, &carry1);
  uint64_t t = FStar_Int_Cast_uint128_to_uint64(&x5) & (uint64_t )0xffffffffffffff;
  uint64_t t0 = t;
  FStar_UInt128_t x6;
  FStar_UInt128_t ret0;
  FStar_UInt128_add(&xy01, &xy10, &ret0);
  FStar_UInt128_t s0 = ret0;
  FStar_UInt128_add(&s0, &carry1, &x6);
  FStar_UInt128_t carry2;
  FStar_UInt128_shift_right(&x6, (uint32_t )56, &carry2);
  uint64_t t1 = FStar_Int_Cast_uint128_to_uint64(&x6) & (uint64_t )0xffffffffffffff;
  uint64_t t11 = t1;
  FStar_UInt128_t x7;
  FStar_UInt128_t ret1;
  FStar_UInt128_t ret2;
  FStar_UInt128_add(&xy02, &xy11, &ret2);
  FStar_UInt128_t s00 = ret2;
  FStar_UInt128_add(&s00, &xy20, &ret1);
  FStar_UInt128_t s01 = ret1;
  FStar_UInt128_add(&s01, &carry2, &x7);
  FStar_UInt128_t carry3;
  FStar_UInt128_shift_right(&x7, (uint32_t )56, &carry3);
  ...
  FStar_UInt128_t ret4;
  FStar_UInt128_t ret5;
  FStar_UInt128_add(&xy03, &xy12, &ret5);
  FStar_UInt128_t s02 = ret5;
  FStar_UInt128_add(&s02, &xy21, &ret4);
  FStar_UInt128_t s03 = ret4;
  FStar_UInt128_add(&s03, &xy30, &ret3);
  FStar_UInt128_t s04 = ret3;
  FStar_UInt128_add(&s04, &carry3, &x8);
  FStar_UInt128_t carry4;
  FStar_UInt128_shift_right(&x8, (uint32_t )56, &carry4);
  ...
  FStar_UInt128_t ret9;
  FStar_UInt128_t ret;
  FStar_UInt128_add(&xy04, &xy13, &ret);
  FStar_UInt128_t s05 = ret;
  FStar_UInt128_add(&s05, &xy22, &ret9);
  FStar_UInt128_t s06 = ret9;
  FStar_UInt128_add(&s06, &xy31, &ret8);
  FStar_UInt128_t s07 = ret8;
  FStar_UInt128_add(&s07, &xy40, &ret7);
  FStar_UInt128_t s08 = ret7;
  FStar_UInt128_add(&s08, &carry4, &ret6);
  FStar_UInt128_t s09 = ret6;
  uint64_t t4 = FStar_Int_Cast_uint128_to_uint64(&s09) & (uint64_t )0xffffffffff;
...
static void Hacl_Impl_BignumQ_Mul_mul_5(FStar_UInt128_t *z, uint64_t *x, uint64_t *y)
{
  ...
  FStar_UInt128_t xy13;
  FStar_UInt128_mul_wide(x1, y3, &xy13);
  FStar_UInt128_t xy14;
  FStar_UInt128_mul_wide(x1, y4, &xy14);
  FStar_UInt128_t xy20;
  FStar_UInt128_mul_wide(x2, y0, &xy20);
  FStar_UInt128_t xy21;
  FStar_UInt128_mul_wide(x2, y1, &xy21);
  FStar_UInt128_t xy22;
  FStar_UInt128_mul_wide(x2, y2, &xy22);
  FStar_UInt128_t xy23;
  FStar_UInt128_mul_wide(x2, y3, &xy23);
  FStar_UInt128_t xy24;
  FStar_UInt128_mul_wide(x2, y4, &xy24);
  FStar_UInt128_t xy30;
  FStar_UInt128_mul_wide(x3, y0, &xy30);
  FStar_UInt128_t xy31;
  FStar_UInt128_mul_wide(x3, y1, &xy31);
  FStar_UInt128_t xy32;
  FStar_UInt128_mul_wide(x3, y2, &xy32);
  FStar_UInt128_t xy33;
  FStar_UInt128_mul_wide(x3, y3, &xy33);
  FStar_UInt128_t xy34;
  FStar_UInt128_mul_wide(x3, y4, &xy34);
  FStar_UInt128_t xy40;
  FStar_UInt128_mul_wide(x4, y0, &xy40);
  FStar_UInt128_t xy41;
  FStar_UInt128_mul_wide(x4, y1, &xy41);
  FStar_UInt128_t xy42;
  FStar_UInt128_mul_wide(x4, y2, &xy42);
  FStar_UInt128_t xy43;
  FStar_UInt128_mul_wide(x4, y3, &xy43);
  FStar_UInt128_t xy44;
  FStar_UInt128_mul_wide(x4, y4, &xy44);
  FStar_UInt128_t z0 = xy00;
  FStar_UInt128_t z1;
  FStar_UInt128_add(&xy01, &xy10, &z1);
  FStar_UInt128_t z2;
  FStar_UInt128_t ret0;
  FStar_UInt128_add(&xy02, &xy11, &ret0);
  FStar_UInt128_t s0 = ret0;
  FStar_UInt128_add(&s0, &xy20, &z2);
  FStar_UInt128_t z3;
  FStar_UInt128_t ret1;
  FStar_UInt128_t ret2;
  FStar_UInt128_add(&xy03, &xy12, &ret2);
  FStar_UInt128_t s00 = ret2;
  FStar_UInt128_add(&s00, &xy21, &ret1);
  FStar_UInt128_t s01 = ret1;
  FStar_UInt128_add(&s01, &xy30, &z3);
  FStar_UInt128_t z4;
  FStar_UInt128_t ret3;
  FStar_UInt128_t ret4;
  FStar_UInt128_t ret5;
  FStar_UInt128_add(&xy04, &xy13, &ret5);
  FStar_UInt128_t s02 = ret5;
  FStar_UInt128_add(&s02, &xy22, &ret4);
  FStar_UInt128_t s03 = ret4;
  FStar_UInt128_add(&s03, &xy31, &ret3);
  FStar_UInt128_t s04 = ret3;
  FStar_UInt128_add(&s04, &xy40, &z4);
  FStar_UInt128_t z5;
  FStar_UInt128_t ret6;
  FStar_UInt128_t ret7;
  FStar_UInt128_add(&xy14, &xy23, &ret7);
  FStar_UInt128_t s05 = ret7;
  FStar_UInt128_add(&s05, &xy32, &ret6);
  FStar_UInt128_t s06 = ret6;
  FStar_UInt128_add(&s06, &xy41, &z5);
  FStar_UInt128_t z6;
  FStar_UInt128_t ret;
  FStar_UInt128_add(&xy24, &xy33, &ret);
  FStar_UInt128_t s07 = ret;
  FStar_UInt128_add(&s07, &xy42, &z6);
  FStar_UInt128_t z7;
  FStar_UInt128_add(&xy34, &xy43, &z7);
...
)
{
  ...
  FStar_UInt128_t ret;
  FStar_Int_Cast_uint64_to_uint128((uint64_t )0, &ret);
  KRML_CHECK_SIZE(ret, (uint32_t )9);
